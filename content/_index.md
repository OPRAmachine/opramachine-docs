...
{{% notice warning %}}Last updated: June 27th, 2018{{% /notice %}}
...
This documentation is [open source and editable using Github](https://github.com/gavinrozzi/opramachine-docs/). If you would like to help improve the content & quality of this documentation, feel free to make changes and submit them for our consideration. Just click the **Edit this page** link displayed on top right of each page, and submit a pull request with your changes. Your changes will be deployed automatically when merged after review.
